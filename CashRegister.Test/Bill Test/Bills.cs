...
namespace CashRegister.Test.Bill
{
    [TestFixture]
    public class Bills
    {
        ...
        public async Task GetBillByBillNumber_WhenCalled_ReturnBill()
        {
            ...
            var repo = _billRepositoryMock.Setup(c => c.GetByPKAsync(It.IsAny<object>())).ReturnsAsync((new Domain.Models.Bill
            {
                BillNumber = "1",
                CreditCardNumber = "1",
                PaymentMethod = "card",
        ...
        public async Task UpdateBill_WhenCalled_Success()
        {
            ...
            _billRepositoryMock.Verify(c => c.Update(It.IsAny<Domain.Models.Bill>()));
        ...
        public async Task CreateBill_WhenCall_CreateBill()
        {
            ...
            _billRepositoryMock.Verify(r => r.Insert(It.IsAny<Domain.Models.Bill>()));
            _billRepositoryMock.Verify(r => r.Save());
        }
